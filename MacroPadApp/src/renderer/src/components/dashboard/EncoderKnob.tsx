// =============================================================================
// EncoderKnob — animated rotary encoder visualisation
// =============================================================================
...
export function EncoderKnob(): JSX.Element {
  ...
  const angle       = (position * 15) % 360   // 15° per step
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="text-center">
        <p className="text-[10px] text-slate-600 uppercase tracking-wider">Encoder</p>
        <p className="text-sm font-mono font-semibold text-slate-200">{position}</p>
      </div>
    </div>
  )
}
